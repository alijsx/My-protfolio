...
export default function EnsVision() {
  const tasks = [
    {
      text: "Worked on the front-end development in  React.js, Firebase, Tailwind CSS, Bootstrap ,  Javascript",
      ...
      <div className="flex flex-col space-y-5 max-w-xl px-4 md:px-0">
        <div className="flex flex-col spacey-y-2">
          ...
          <span className="text-gray-100 sm:text-lg text-sm font-Arimo tracking-wide">
            Intern<span className="text-AAsecondary">@ Frontend Developer</span>
          </span>
          {/* Date */}
          <span className="font-mono text-xs text-gray-500">july 2023 - Present</span>
          <span
            className="font-mono text-xs text-AAsecondary hover:cursor-pointer"
            style={{ fontSize: "0.6rem" }}
            // set on click to open the website
            onClick={() => window.open("https://preesoft.com/", "_blank")}
          >
          www.preesoft.com
          </span>
        </div>
