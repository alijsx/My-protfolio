        ...
        <div data-aos="fade-up" className="relative md:grid md:grid-cols-12 w-full md:h-96 ">
          ...
          >
           ...
           transition-opacity opacity-20 hover:opacity-0 hover:cursor-pointer duration-300"
              ...
              <a href="https://sumz.surge.sh/" target={"_blank"} rel="noreferrer">
                <div
                  // onClick={}
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            >
              <div className="flex flex-col space-y-1 md:items-end z-10">
                <span className="text-AAsecondary text-base">SUMZ</span>
                <a href="https://sumz.surge.sh/" target="_blank" rel="noopener noreferrer">
...
If you're a solo developer in 2023, you have the power to build robust AI software startups! Watch this and make an Article Summarizer Application using OpenAI's GPT model.
              ...
              >
                ...
                <span className="pr-4 z-10">Rapid Api</span>
                <span className="pr-4 z-10">Talwind css</span>
        ...
        <div data-aos="fade-up" className="relative md:grid md:grid-cols-12 w-full md:h-96  ">
          ...
          >
            <div className="relative rounded w-full h-full col-start-6 col-span-7 ">
              <a href={"https://updatedtopro.web.app/"} target="_blank" rel="noreferrer">
                <div
                  className="absolute w-full h-full rounded bg-AAprimary 
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            >
              <div className="flex flex-col space-y-1  z-10">
                ...
                <a href="https://updatedtopro.web.app/" target="_blank" rel="noopener noreferrer">
                  <span className=" md:text-gray-200 text-AAsecondary font-bold text-xl hover:cursor-pointer">
                  Updated To Pro -V1
                  </span>
                </a>
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                ...
                Social Media App For Free Courses
                </p>
              </div>
              <ul
                className="flex flex-wrap w-full text-gray-300 md:text-gray-400
              ...
              >
                ...
                <span className="pr-4 z-10">Type Script</span>
                <span className="pr-4 z-10">Custom Css</span>
                <span className="pr-4 z-10">Responsive</span>
                {/* <span className="pr-4 z-10">Blockchain</span> */}
              </ul>
              <div className="z-10 flex fle-row space-x-5 ">
                <GithubIcon link="https://github.com/aliaalam404/social-media-app" />
                <a href="https://updatedtopro.web.app/" target={"_blank"} rel="noreferrer">
                  <ExternalLink url={""} router={router} />
                </a>
              </div>
