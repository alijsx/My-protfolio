      ...
      >
        <div className="flex flex-col space-y-8 justify-center items-center">
          <div className="flex flex-col justify-center items-center space-y-5">
            {/* Github Icon */}
            <IconClickableWithAnimation Icon={GithubIcon} href={"https://github.com/aliaalam404"} />
            {/* Linkedin icon */}
            <IconClickableWithAnimation Icon={LinkedinIcon} href={"https://www.linkedin.com/in/aliaalam404/"} />
            {/* Instagram Icon */}
            <IconClickableWithAnimation Icon={InstagramIcon} href={"https://www.instagram.com/aliaalam404/"} />
            {/* Youtube Icon */}
      ...
      >
        <div className="flex flex-col space-y-24 justify-center items-center">
          ...
          <motion.div
            ...
            className=""
          >
            <a href="mailto:aliaalam.me@gmail.com" target={"_blank"} rel="noreferrer">
              <span className=" font-Header tracking-wider text-gray-400 hover:text-AAsecondary hover:cursor-pointer">
                aliaalam.me<span className="text-AAsecondary">@</span>mail<span className="text-AAsecondary">.</span>com
              </span>
            </a>
          </motion.div>
